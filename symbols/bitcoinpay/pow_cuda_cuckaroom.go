...
func (this *CudaCuckaroom) Update() {
	...
	if this.Pool {
		...
		this.Work.PoolWork.WorkData = this.Work.PoolWork.PrepBitcoinpayWork()
...
func (this *CudaCuckaroom) CardRun() bool {
	...
	go func() {
		...
		cbytes := cycleNoncesBytes[0 : 42*4]

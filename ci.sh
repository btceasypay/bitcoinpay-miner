...
wget -O libcuckoo.zip https://github.com/btceasypay/cuckoo-lib/releases/download/v0.0.1/libcuckoo.zip
unzip libcuckoo.zip -d lib/cuckoo/target/
wget -O libOpenCL.zip https://github.com/btceasypay/OpenCL-ICD-Loader/releases/download/v0.0.1/libopencl.zip
